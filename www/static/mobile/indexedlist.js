...
(function($, window, document) {
   ...
   var IndexedList = $.IndexedList = $.Class.extend({
      ...
      findElements: function() {
         var self = this;
         self.el = self.el || {};
         self.el.search = document.querySelector(classSelector('indexed-list-search'));
         self.el.searchInput = document.querySelector(classSelector('indexed-list-search-input'));
         self.el.searchClear = document.querySelector(classSelector('indexed-list-search') + ' ' + classSelector('icon-clear'));
